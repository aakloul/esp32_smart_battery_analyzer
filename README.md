...
- datasheet_schematics
  ...
  - for recent schematic, go to instructables.com link
- gerber
  - contains gerber file from PCBway for production
- stl
  - contains stl files for 3D printing the pcb housing and buttons
- bom
  - bill of materials
- sources
  - source code
